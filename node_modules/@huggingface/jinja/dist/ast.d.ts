...
export declare class Macro extends Statement {
    ...
    body: Statement[];
    type: string;
    constructor(name: Identifier, args: Parameter[], body: Statement[]);
}
...
export declare class KeywordSpreadExpression extends Expression {
    argument: Expression;
    type: string;
    constructor(argument: Expression);
}
export declare class CallStatement extends Statement {
    call: CallExpression;
    callerArgs: Parameter[] | null;
    body: Statement[];
    type: string;
    constructor(call: CallExpression, callerArgs: Parameter[] | null, body: Statement[]);
}

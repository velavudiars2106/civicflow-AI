...
export type AnyRuntimeValue = IntegerValue | FloatValue | StringValue | BooleanValue | ObjectValue | NamespaceValue | ArrayValue | FunctionValue | NullValue | UndefinedValue;
/**
 ...
 */
export declare class NamespaceValue extends RuntimeValue<Map<string, AnyRuntimeValue>> {
    type: string;
    toString(): string;
}
/**
